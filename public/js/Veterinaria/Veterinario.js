...
function AgregarCamposDireccion() {
    ...
    <div class="col-md-2">
        ...
        <input type="text"
                ...
                name="Veterinario[Direccion][${idDireccion}][descripcion]" 
    ...
    <div class="col-md-4">
        ...
        <input type="text"
                ...
                name="Veterinario[Direccion][${idDireccion}][direccion]"
                maxlength="150" 
                required>
        <div class="invalid-tooltip">
            Campo Requerido
    ...
    <div class="col-md-2">
        ...
        <input type="text"
                class="form-control"
                placeholder="Latitud"
                name="Veterinario[Direccion][${idDireccion}][latitud]"
                maxlength="12" 
                required>
        <div class="invalid-tooltip">
            Aviso
    ...
    <div class="col-md-2">
        ...
        <input type="text"
                ...
                name="Veterinario[Direccion][${idDireccion}][longitud]"
                maxlength="12"
                required>
        <div class="invalid-tooltip">
            Aviso
    ...
    <div class="col-md-2">
        ...
        nroDireccion += 1;
        idDireccion += 1;
        $('#VeterinarioDirecciones').append(element);
    }
}
